...
description: The core smart contracts and privacy-preserving primitives of Fhish.
---

## Overview

Fhish is a decentralized yield-serviced credit protocol that utilizes Fully Homomorphic Encryption (FHE) to provide confidential lending and capital-efficient borrowing.
