---
title: Fhish Checkout App
description: A drop-in checkout component for decentralized payments.
---

## Overview

The Fhish Checkout App is a lightweight, embeddable interface for handling specific payment transactions.

### Key Features

- **Embeddable Modal**: Easily add Fhish to any website with just a few lines of code.
