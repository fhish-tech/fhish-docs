---
title: Fhish Core Overview
description: The backend orchestration and data management layer of Fhish.
---

## Overview

Fhish Core is the primary Next.js backend for the Obolus Network, renamed Fhish. It handles the core business logic, API orchestration, and database integration.
...
Fhish Core uses a distributed database architecture:
